    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button className="h-7 min-w-7 shrink-0 flex flex-col items-center justify-center rounded-sm hover:bg-neutral-400/80 px-1.5 overflow-hidden text-sm">
...
const FontSizeButton = ()=>{
    ...
    const updatFontSize = (newSize: string)=>{
    ...
    const increment = () =>{
        ...
        updatFontSize(newSize.toString())
    }
    ...
    return(
        <div className="flex items-center gap-x-0.5">
            ...
            {isEditing?(
                ...
                className="h-7 w-10  text-sm border border-neutral-400 text-center rounded-sm bg-transparent focus:ring-0 focus:outline-none"
                />
            ):(
                <button
                onClick={()=>{
        ...
        <>
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent>
                    ...
                    />
                    <DialogFooter>
                        <Button onClick={handleImgUrlSubmit}>
                            Insert
                        </Button>
                    </DialogFooter>                    
                </DialogContent>
...
const HeadingLevelButton= () =>{
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button className="h-7 min-w-7 shrink-0 flex items-center justify-center rounded-sm hover:bg-neutral-400/80 px-1.5 overflow-hidden text-sm">
            ...
            <DropdownMenuContent className="px-1 flex flex-col gap-y-1">
...
const FontFamilyButton =()=>{
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button className="h-7 w-[120px] shrink-0 flex items-center justify-between rounded-sm hover:bg-neutral-400/80 px-1.5 overflow-hidden text-sm">
                    <span className="truncate">
            ...
            <DropdownMenuContent className="px-1 flex flex-col gap-y-1">
                {fonts.map(({label, value})=>(
                    <button
                        ...
                        className= {cn(
                            "flex items-center gap-x-2 px-2 py-1 rounded-sm hover:bg-neutral-400/80",
                            editor?.getAttributes("textStyle").fontFamily === value && "bg-neutral-400/80"
...
const ToolbarButton = ({onClick,isActive,icon: Icon}: ToolbarButtonProps)=>{
    return(
        <button onClick={onClick} className={cn(
            ...
            isActive && "bg-neutral-300 text-black shadow-inner"
        )}>
            <Icon className="size-4" />
        </button>
    )
